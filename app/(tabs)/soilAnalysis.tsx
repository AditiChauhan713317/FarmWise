    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      >
        ...
        <View className="mt-4 rounded-2xl border border-red-200 bg-red-50 p-4">
          <Text className="font-semibold text-red-700">🔧 Debug Info</Text>
          <Text className="mt-2 text-xs text-gray-600">
            API Key Status: {Constants.expoConfig?.extra?.openaiApiKey ? "✅ Found" : "❌ Missing"}
          </Text>
          <Text className="text-xs text-gray-600">
            Key Preview: {Constants.expoConfig?.extra?.openaiApiKey ? 
              Constants.expoConfig.extra.openaiApiKey.substring(0, 10) + "..." : 
              "Not available"
            }
          </Text>
        </View>
